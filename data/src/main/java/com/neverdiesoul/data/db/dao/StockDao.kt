...
interface StockDao {
    ...
    suspend fun insertCoinMarketCodeEntity(vararg coinMarketCodeEntity: CoinMarketCodeEntity): LongArray

    @Query("SELECT * FROM CoinMarketCodes")
    suspend fun getCoinMarketCodeAllFromLocal(): List<CoinMarketCodeEntity>
}